...
video_analise_page = st.Page("analise_video.py",title= "Análise Vídeo")

# analise_gols_vizu_page = st.Page("analise_gols_vizu.py",title= "Análise Gols Visualização")


pg = st.navigation([equipes_page, jogos_page, jogadas_page, analise_tempo_real_page, analise_atleta_page,video_analise_page ])
pg.run()
